...
LDFLAGS        := -T undefined_syms.txt -T undefined_funcs.txt -T undefined_funcs_auto.txt -T undefined_syms_auto.txt -T undefined_syms_bss.txt -T $(LD_SCRIPT) -Map $(LD_MAP) --no-check-sections
