...
void func_80037CE0(void) {
    ...
    D_800ED730 = HuMemAlloc(128 * sizeof(unk388E0Struct80));
...
INCLUDE_ASM(s32, "388E0", func_80037FA0);
...
INCLUDE_ASM(s32, "388E0", func_80038178);
...
INCLUDE_ASM(s32, "388E0", func_80038254);

INCLUDE_ASM(s32, "388E0", func_800384FC);

INCLUDE_ASM(s32, "388E0", func_80038720);

INCLUDE_ASM(s32, "388E0", func_800387DC);

INCLUDE_ASM(s32, "388E0", func_80038864);

INCLUDE_ASM(s32, "388E0", func_80038888);
...
INCLUDE_ASM(s32, "388E0", func_80038A9C);
...
INCLUDE_ASM(s32, "388E0", func_80039084);

INCLUDE_ASM(s32, "388E0", func_80039644);

INCLUDE_ASM(s32, "388E0", func_8003967C);

INCLUDE_ASM(s32, "388E0", func_800396B0);

INCLUDE_ASM(s32, "388E0", func_80039758);

INCLUDE_ASM(s32, "388E0", func_800397AC);

INCLUDE_ASM(s32, "388E0", func_80039970);

INCLUDE_ASM(s32, "388E0", func_800399F0);

INCLUDE_ASM(s32, "388E0", func_80039A4C);

INCLUDE_ASM(s32, "388E0", func_80039ACC);

INCLUDE_ASM(s32, "388E0", func_80039AEC);

INCLUDE_ASM(s32, "388E0", func_80039BAC);

INCLUDE_ASM(s32, "388E0", func_80039C48);

INCLUDE_ASM(s32, "388E0", func_80039D10);

INCLUDE_ASM(s32, "388E0", func_80039F9C);

INCLUDE_ASM(s32, "388E0", func_80039FFC);
