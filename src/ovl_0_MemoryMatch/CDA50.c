...
INCLUDE_ASM(s32, "ovl_0_MemoryMatch/CDA50", func_800F6858_CDCC8);

INCLUDE_ASM(s32, "ovl_0_MemoryMatch/CDA50", func_800F68CC_CDD3C);

INCLUDE_ASM(s32, "ovl_0_MemoryMatch/CDA50", func_800F714C_CE5BC);

INCLUDE_ASM(s32, "ovl_0_MemoryMatch/CDA50", func_800F71C4_CE634);

INCLUDE_ASM(s32, "ovl_0_MemoryMatch/CDA50", func_800F7318_CE788);

INCLUDE_ASM(s32, "ovl_0_MemoryMatch/CDA50", func_800F7350_CE7C0);

INCLUDE_ASM(s32, "ovl_0_MemoryMatch/CDA50", func_800F73A4_CE814);

INCLUDE_ASM(s32, "ovl_0_MemoryMatch/CDA50", func_800F7874_CECE4);

INCLUDE_ASM(s32, "ovl_0_MemoryMatch/CDA50", func_800F796C_CEDDC);
