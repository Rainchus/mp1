...
void func_800F65E0_EE9A0(void) {
    ...
    D_800FE6F8_F6AB0 = 0;
    D_800FE6F6_F6AB0 = 1;
    D_800FE6FA_F6AB0 = 2700;
    D_800FE6FC_F6AB0 = IsFlagSet(0x2B);

    for (i = 0; i < ARRAY_COUNT(D_800FED40_F6AB0); i++) {
        D_800FED40_F6AB0[i] = 0;
    }
    ...
    D_800FF258_F6AB0 = func_800AEAC0(temp_s0_2->unk_40 / 2.0) / func_800AEFD0(temp_s0_2->unk_40 / 2.0);

    guMtxL2F(D_800FF140_F6AB0, &temp_s0_2->unk_138);
    guMtxL2F(D_800FFAE0_F6AB0, &temp_s0_2->unk_138);
    func_800FA678_F2A38(D_800FFAE0_F6AB0);
    func_800FBB0C_F3ECC();

    D_800FE768_F6AB0 = func_80076FF4(124);
    D_800FF248_F6AB0 = func_8005D384(10, 0, 0, -1, &func_800F6B2C_EEEEC);
    ...
    for (i = 0; i < 10; i++) {
        D_800FED08_F6AB0[D_800FF25C_F6AB0++] = func_8005D384(4, 1, 0, -1, &func_800F75AC_EF96C);
    }

    D_800FF24C_F6AB0[D_800FED30_F6AB0++] = temp_v0_4 = func_8005D384(5, 3, 0, -1, &func_800F7470_EF830);
    func_8005D8B8(temp_v0_4, 160);

    D_800FF24C_F6AB0[D_800FED30_F6AB0++] = temp_v0_4 = func_8005D384(5, 2, 0, -1, &func_800F74E8_EF8A8);
    func_8005D8B8(temp_v0_4, 160);

    D_800FE764_F6AB0 = func_8005D384(0, 0, 0, -1, &func_800F6F18_EF2D8);
