...
INCLUDE_ASM(const s32, "ovl_76/2FA8D0", func_800F6854_2FAB14);

INCLUDE_ASM(const s32, "ovl_76/2FA8D0", func_800F687C_2FAB3C);

INCLUDE_ASM(const s32, "ovl_76/2FA8D0", func_800F6898_2FAB58);

INCLUDE_ASM(const s32, "ovl_76/2FA8D0", func_800F68B4_2FAB74);

INCLUDE_ASM(const s32, "ovl_76/2FA8D0", func_800F68D0_2FAB90);

INCLUDE_ASM(const s32, "ovl_76/2FA8D0", func_800F68EC_2FABAC);

INCLUDE_ASM(const s32, "ovl_76/2FA8D0", func_800F6908_2FABC8);

INCLUDE_ASM(const s32, "ovl_76/2FA8D0", func_800F6924_2FABE4);

INCLUDE_ASM(const s32, "ovl_76/2FA8D0", func_800F6948_2FAC08);
