...
INCLUDE_ASM(const s32, "ovl_01_ChanceTime/DAF90", func_800FC390_DAF90);
...
INCLUDE_ASM(const s32, "ovl_01_ChanceTime/DAF90", func_800FE97C_DD57C);

INCLUDE_ASM(const s32, "ovl_01_ChanceTime/DAF90", func_800FE9D8_DD5D8);
