...
void func_800F65E0_2872A0(void) {
    ...
    func_8006CEA0();
    InitProcess(&func_800F6CB0_287970, 0x300, 0, 0);
    func_8005D384(0x1000, 0, 0, -1, &func_800F7688_288348);
    if (D_800C597A != 0) {
...
INCLUDE_ASM(s32, "ovl_4A_GoombaCoinStealPeachBoard/2872A0", func_800F6CB0_287970); //large
