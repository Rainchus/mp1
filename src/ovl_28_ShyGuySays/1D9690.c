...
void func_800F8818_1DB8C8(unkObjectStruct* arg0) {
    ...
    *((UnknownBlock24*) sp10) = D_800FD6C8;
    temp_s2 = &D_800FD9C0[arg0->unk_4C[0]];
...
void func_800F9118_1DC1C8(unkObjectStruct* arg0, s16 arg1) {
    ...
    temp_s0 = &D_800FD9C0[arg0->unk_4C[0]];
...
void func_800FBE60_1DEF10(unkObjectStruct* arg0) { //main step function?
    u16 sp18[25];
    f32 var_f12;
    u16 var_s3;
    u32 temp_a0;
    ...
    *((UnknownBlock36*) &sp18[8]) = D_800FD860;
    ...
    func_800FD274_1E0324(arg0->unk_40[0], D_800FDC50, func_800AEAC0(D_800FD5E4), sp18, &sp18[4]);
    func_800FD274_1E0324(arg0->unk_40[0], D_800FDC52, func_800AEFD0(D_800FD5E4), sp18, &sp18[4]);
