...
INCLUDE_ASM("asm/nonmatchings/ovl_28_ShyGuySays/1D9690", func_800FBE60_1DEF10); //main step function?

INCLUDE_ASM("asm/nonmatchings/ovl_28_ShyGuySays/1D9690", func_800FCA8C_1DFB3C); //a1 is flag chosen (1 is B, 2 is A, 3 is fake out)
