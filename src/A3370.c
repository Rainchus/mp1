...
void func_800AF2E0_AFEE0(f32, f32*, f32*);
...
void func_800A2770_A3370(Matrix4f arg0, u16* perspNorm, unkFloatStruct* arg2) {
    f32 sp10;
    f32 sp14;
    f32 sp18;
    f32 sp1C;
    ...
    func_800AF2E0_AFEE0(arg2->unk_00 * 0.5f, &sp1C, &sp20);
