...
omObjData* D_800F7854_28CEE4 = NULL;
Object* D_800F7858_28CEE8 = NULL;
omObjData* D_800F785C_28CEEC = NULL;
...
void func_800F65E0_28BC70(void) {
    ...
    func_8006CEA0();
    omAddPrcObj(func_800F67BC_28BE4C, 0x300, 0, 0);
    omAddObj(0x1000, 0, 0, -1, &func_800F737C_28CA0C);
    SetFadeInTypeAndTime(4, 0x10);
}

void func_800F66B4_28BD44(omObjData* arg0) {
    func_800264F8(*D_800F7848_28CED8->unk_3C->unk_40, D_800F7850_28CEE0, arg0->trans.x, "pukuSa-bmerge1", "pukuSa-bmerge2", 0);
}

void func_800F6708_28BD98(omObjData* arg0) {
    Object* temp_s0;
...
void func_800F67BC_28BE4C(void) {
    ...
    for (i = 0; i < 0x37; i++) {
        ...
        if ((i < 0x2D) == 0) {
            D_800F7854_28CEE4->trans.x = 1.0f - ((i - 0x2D) / 10.0f);
    ...
    D_800F7854_28CEE4->trans.x = 0.0f;
    HuPrcSleep(0xA);
    ...
    for (; i <= 0; i += 10) {
        D_800F7848_28CED8->unk_3C->unk_24 = i;
        D_800F7854_28CEE4->trans.x = (i / 30.0f) + 1.0f;
        HuPrcVSleep();
    }
...
void func_800F737C_28CA0C(omObjData* arg0) {
    if (D_800F5144 != 0) {
        func_800726AC(4, 16);
...
void func_800F73C0_28CA50(void) {
    func_8003DAA8();
    func_8004F2AC();
    D_800F7844_28CED4 = CreateObject(6, &D_800F78F0_28CF80);
    ...
    D_800F784C_28CEDC = CreateObject(0x70, NULL);
    ...
    D_800F7854_28CEE4 = omAddObj(0x1000, 0, 0, -1, &func_800F66B4_28BD44);
    D_800F7854_28CEE4->trans.x = 1.0f;
    D_800F7858_28CEE8 = CreateObject(0x71, NULL);
    ...
    D_800F785C_28CEEC = omAddObj(0x1000, 0, 0, -1, &func_800F6708_28BD98);
    D_800F785C_28CEEC->trans.x = 0.0f;
}
