...
unkStructSize0x5C* func_800F87A8_EB128(omObjData* arg0) {
...
unkStructSize0x5C* func_800F8914_EB294(omObjData* arg0) {
...
#else
INCLUDE_ASM(const s32, "overlays/ovl_03_BuriedTreasure/EB0E0", func_800F8D1C_EB69C);
#endif
...
#else
INCLUDE_ASM(const s32, "overlays/ovl_03_BuriedTreasure/EB0E0", func_800F8EF0_EB870);
#endif
...
#else
INCLUDE_ASM(const s32, "overlays/ovl_03_BuriedTreasure/EB0E0", func_800F9E10_EC790);
#endif
...
void func_800F9F90_EC910(void) {
    ...
    D_800FC05C = omAddObj(5, 0, 0, -1, &func_800FA090_ECA10);
...
void func_800FA090_ECA10(omObjData* arg0) {
...
void func_800FA138_ECAB8(void) {
    ...
    D_800FC060 = omAddObj(0, 3, 2, -1, NULL);
    ...
    for (i = 0; i < ARRAY_COUNT(D_800FC5C0); i++) {
        ...
        if (i & 1) {
            ...
            *var_s2->unk_00 = func_800F9C40_EC5C0(2, var_s2->unk_0C - 160, var_s2->unk_0E - 120, 0);
            ...
            D_800FC060->model[0] = LoadFormFile(0x150005, 0x99);
            D_800FC060->model[1] = LoadFormFile(0x150006, 0x9D);
            D_800FC060->model[2] = LoadFormFile(0x150005, 0x49D);

            D_800F2B7C[D_800FC060->model[0]].unk_4C = 0.0f;
            D_800F2B7C[D_800FC060->model[2]].unk_4C = 0.0f;

            func_800F8BB8_EB538(var_s2->unk_0C - 160, var_s2->unk_0E - 120, -400.0f, &sp18);

            D_800FC060->trans.x = sp18.x;
            D_800FC060->trans.y = sp18.y;
            D_800FC060->trans.z = sp18.z;
            D_800FC060->scale.z = 0.25f;
            D_800FC060->scale.y = 0.25f;
            D_800FC060->scale.x = 0.25f;
            D_800FC060->rot.x = 0.0f;
            D_800FC060->rot.y = -30.0f;
            D_800FC060->rot.z = 0.0f;

            for (j = 0; j < 2; j++) {
                if (j == 0) {
                    func_80025798(D_800FC060->model[1], D_800FC060->trans.x, D_800FC060->trans.y, D_800FC060->trans.z);
                } else {
                    func_800F8BB8_EB538(var_s2->unk_0C - 160, var_s2->unk_0E - 120, 0.0f, &sp18);
                    func_80025798(D_800FC060->model[j + 1], sp18.x, sp18.y, sp18.z);
                }
                func_80025830(D_800FC060->model[j + 1], D_800FC060->scale.x, D_800FC060->scale.y, D_800FC060->scale.z);
                func_800257E4(D_800FC060->model[j + 1], D_800FC060->rot.x, D_800FC060->rot.y, D_800FC060->rot.z);
            }

            var_s2->unk_20 = D_800FC060;
            D_800FC060->work[0] = 0;
            var_s2->unk_06 = D_800FC060->model[0];
            var_s2->unk_08 = 2;
        }
...
#else
INCLUDE_ASM(const s32, "overlays/ovl_03_BuriedTreasure/EB0E0", func_800FA90C_ED28C);
#endif
...
omObjData* func_800FB62C_EDFAC(unkStructSize0x28* arg0) {
    unkStructSize0x5C* temp_v0;
    omObjData* var_s1;
    s32 temp_f0;
    s32 var_s2;
...
s16 func_800FB780_EE100(void) {
    ...
    for (i = 0; i < 1; i++) {
        ...
        if (i == 0) {
            ...
            D_800F2B7C[D_800FC060->model[0]].unk_20 |= 4;
            D_800F2B7C[D_800FC060->model[1]].unk_20 |= 4;
            D_800F2B7C[D_800FC060->model[2]].unk_20 &= ~4;
            D_800F2B7C[D_800FC060->model[2]].unk_4C = 1.0f;
