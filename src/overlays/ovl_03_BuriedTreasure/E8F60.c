...
void func_800F65E0_E8F60(void) {
    ...
    D_800FC144 = omAddObj(0xA, 0, 0, -1, &func_800F692C_E92AC);

    for (i = 0; i < 4; i++) {
        D_800F3FB0[D_800F2BC0++] = omAddObj(3, 1, 2, -1, &func_800F6EC4_E9844);
    }

    D_800FC030 = omAddObj(0, 0, 0, -1, &func_800F6DCC_E974C);
    func_800F9F90_EC910();
}

void func_800F692C_E92AC(omObjData* arg0) {
...
#else
INCLUDE_ASM(s32, "overlays/ovl_03_BuriedTreasure/E8F60", func_800F6958_E92D8);
#endif
...
void func_800F6DCC_E974C(omObjData* arg0) {
    arg0->work[0] = func_80075CCC(8, D_800FC028 / 30, 160, 24);
    arg0->func_ptr = &func_800F6E44_E97C4;
}

void func_800F6E44_E97C4(omObjData* arg0) {
...
void func_800F6EC4_E9844(omObjData* arg0) {
    ...
    arg0->trans.x = D_800FBA7C_EE3FC[D_800FC02C].unk_00;
    arg0->trans.y = D_800FBA7C_EE3FC[D_800FC02C].unk_02;
    arg0->trans.z = D_800FBA7C_EE3FC[D_800FC02C].unk_04;
    arg0->rot.x = 90.0f;
    arg0->rot.z = D_800FBA94_EE414[D_800FC02C];
    arg0->scale.z = 0.14f;
    arg0->scale.y = 0.14f;
    arg0->scale.x = 0.14f;
    ...
    arg0->unk_50 = HuMemTempDirectMalloc(sizeof(unkGlobalStruct_00), 31000);
    func_8009B770(arg0->unk_50, 0, sizeof(unkGlobalStruct_00));

    temp_s1 = arg0->unk_50;
    temp_s1->unk_3C = arg0->rot.z + 180.0f;

    temp_s1->unk_D8 = HuMemTempDirectMalloc(arg0->mtncnt * sizeof(unkGlobalStruct_00), 31000);
...
void func_800F7164_E9AE4(omObjData* arg0) {
    unkGlobalStruct_00* temp_s1;
...
#else
INCLUDE_ASM(s32, "overlays/ovl_03_BuriedTreasure/E8F60", func_800F7164_E9AE4);
#endif
...
#else
INCLUDE_ASM(s32, "overlays/ovl_03_BuriedTreasure/E8F60", func_800F7E48_EA7C8);
#endif
...
s32 func_800F85B4_EAF34(omObjData* arg0) {
    unkStructSize0x5C* temp_v0;
    f32 temp_f0;
    f32 temp_f12;
    s32 temp_f2;
