...
void func_800F65E0_286700(void) {
    ...
    func_8006CEA0();
    omAddPrcObj(func_800F66BC_2867DC, 0x300, 0, 0);
    omAddObj(0x1000, 0, 0, -1, &func_800F6DCC_286EEC);
    func_80060128(18);
...
void func_800F6C10_286D30(omObjData* arg0) {
    Object* temp_s0;
    Object* temp_s0_2;
    Object* temp_s0_3;
    ...
    if ((arg0->work[0] == 0) || !(arg0->rot.x < -310.0f)) {
        ...
        temp_s0_3->unk_30 = ((sinf(arg0->rot.y * 0.017453292519943295)) * 4.0f) + D_800F70DC[1].y;
...
void func_800F6DCC_286EEC(omObjData* arg0) {
    if (D_800F5144 != 0) {
        func_800726AC(3, 16);
        func_800601D4(32);
...
void func_800F6E18_286F38(void) {
    ...
    D_800F7190 = omAddObj(0x1000, 0, 0, -1, &func_800F6C10_286D30);
    D_800F7190->rot.x = -12.0f;
    D_800F7190->rot.y = 0.0f;
    D_800F7190->work[0] = 0;
    D_800F7188->unk_0A |= 1;
