...
INCLUDE_ASM(const s32, "overlays/ovl_0A_GhostGuess/11BFE0", func_800FB3B0_11BFE0);
...
INCLUDE_ASM(const s32, "overlays/ovl_0A_GhostGuess/11BFE0", func_800FB514_11C144);
