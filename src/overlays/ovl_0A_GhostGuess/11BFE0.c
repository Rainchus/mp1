...
INCLUDE_ASM("asm/nonmatchings/overlays/ovl_0A_GhostGuess/11BFE0", func_800FB448_11C078);

INCLUDE_ASM("asm/nonmatchings/overlays/ovl_0A_GhostGuess/11BFE0", func_800FB4B0_11C0E0);
