...
void func_800090C4(omObjData*, s32, u8);
void func_800F9908_149528(omObjData*);
...
void func_800F9094_148CB4(omObjData*);

void func_800F8C20_148840(omObjData* arg0) {
    s32 temp_s0;
    s32 temp_s1;
    s32 temp_s3;
    s32 temp_v0;
    ...
    arg0->model[4] = LoadFormFile(0x1A, 0x68D);
    arg0->model[5] = LoadFormFile(0x1C, 0x68D);
...
void func_800F9094_148CB4(omObjData* arg0) { //related to movement
    ...
    case 1:
        ...
        if (arg0->trans.x > D_800FA2DC) {
            if ((arg0->trans.x + (-D_800FA2DC)) < 10.0f) {
                D_800FA2D8 = 2;
            } else {
                D_800ECE14[temp_s0->unk_56] = -127;
            }
        } else if ((D_800FA2DC + (-arg0->trans.x)) < 10.0f) {
            D_800FA2D8 = 2;
        } else {
            D_800ECE14[temp_s0->unk_56] = 127;
        }
...
INCLUDE_ASM(const s32, "overlays/ovl_12_GroundPound/148840", func_800F9314_148F34);

INCLUDE_ASM(const s32, "overlays/ovl_12_GroundPound/148840", func_800F95D4_1491F4);

INCLUDE_ASM(const s32, "overlays/ovl_12_GroundPound/148840", func_800F9870_149490);

void func_800F9908_149528(omObjData* arg0) {
...
INCLUDE_ASM(const s32, "overlays/ovl_12_GroundPound/148840", func_800F9950_149570);

#ifdef NON_MATCHING
s32 func_800F9A24_149644(omObjData* arg0, f32 arg1) { //matches, needs rodata support
...
#else
INCLUDE_ASM(s32, "overlays/ovl_12_GroundPound/148840", func_800F9A24_149644);
#endif

INCLUDE_ASM(const s32, "overlays/ovl_12_GroundPound/148840", func_800F9B18_149738);
