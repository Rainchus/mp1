...
INCLUDE_ASM(s32, "overlays/ovl_0C_PedalPower/1217D0", func_800F6944_121B34);

void func_800F6CF8_121EE8(void) {
    omAddObj(2, 2, 0, -1, &func_800F6D2C_121F1C);
}

void func_800F6D2C_121F1C(omObjData* arg0) {
    UnkPedalPowerStruct* temp_s1;

    arg0->unk_50 = HuMemTempDirectMalloc(sizeof(UnkPedalPowerStruct), 0x7918);
    ...
    D_800FA73C.z = 600.0f;
    arg0->trans.x = 400.0f;
    arg0->trans.y = D_800FA73C.y;
    arg0->trans.z = D_800FA73C.z;
    arg0->scale.z = 1.2f;
    arg0->scale.y = 1.2f;
    arg0->scale.x = 1.2f;
    arg0->rot.y = -45.0f;
...
INCLUDE_ASM(s32, "overlays/ovl_0C_PedalPower/1217D0", func_800F6ED0_1220C0);

INCLUDE_ASM(s32, "overlays/ovl_0C_PedalPower/1217D0", func_800F73CC_1225BC);

INCLUDE_ASM(s32, "overlays/ovl_0C_PedalPower/1217D0", func_800F7618_122808);
