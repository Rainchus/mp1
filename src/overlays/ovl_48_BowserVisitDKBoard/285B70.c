...
void func_800F65E0_285B70(void) {
    ...
    func_8006CEA0();
    omAddPrcObj(func_800F66BC_285C4C, 0x300, 0, 0);
    omAddObj(0x1000, 0, 0, -1, &func_800F6DD0_286360);
    func_80060128(0x12);
...
void func_800F6C14_2861A4(omObjData* arg0) {
    Object* temp_s0;
    Object* temp_s0_2;
    Object* temp_s0_3;
    ...
    if ((arg0->work[0] == 0) || !(arg0->rot.x < -310.0f)) {
        ...
        temp_s0_3->unk_30 = ((sinf(arg0->rot.y * 0.017453292519943295)) * 4.0f) + D_800F70CC_28665C[1].y;
...
void func_800F6DD0_286360(omObjData* arg0) {
    if (D_800F5144 != 0) {
...
void func_800F6E1C_2863AC(void) {
    ...
    D_800F7180_ovl48 = omAddObj(0x1000, 0, 0, -1, &func_800F6C14_2861A4);
