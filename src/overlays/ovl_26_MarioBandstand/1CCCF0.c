...
void func_800F65E0_1CCCF0(void) {
    ...
    omAddObj(0x2710, 0, 0, -1, &func_800F6F10_1CD620);
    SetFadeInTypeAndTime(0, 0x10);
    D_800FD282 = 1;
}

void func_800F6808_1CCF18(omObjData* arg0) {
    D_800FD280 = 0;
    D_800ED430 = 0;
...
INCLUDE_ASM(s32, "overlays/ovl_26_MarioBandstand/1CCCF0", func_800F68D4_1CCFE4);

INCLUDE_ASM(s32, "overlays/ovl_26_MarioBandstand/1CCCF0", func_800F6B04_1CD214);

INCLUDE_ASM(s32, "overlays/ovl_26_MarioBandstand/1CCCF0", func_800F6F10_1CD620);
