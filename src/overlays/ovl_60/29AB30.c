...
void func_800F65E0_29AB30(void) {
    ...
    func_8006CEA0();
    omAddPrcObj(&func_800F66C4_29AC14, 0x300, 0, 0);
    omAddObj(0x1000, 0, 0, -1, &func_800F6978_29AEC8);
...
void func_800F6978_29AEC8(omObjData* arg0) {
    if (D_800F5144 != 0) {
        func_800726AC(1, 16);
...
void func_800F6B58_29B0A8(void) {
    DestroyObject((Object*) D_800F6EC4);
    DestroyObject((Object*) D_800F6EC8);
    func_8004F1D0();
}
