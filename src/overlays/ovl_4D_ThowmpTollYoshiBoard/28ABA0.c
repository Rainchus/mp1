...
void func_800F65E0_28ABA0(void) {
    ...
    func_8006CEA0();
    omAddPrcObj(&func_800F6A98_28B058, 0x300, 0, 0);
    omAddObj(0x1000, 0, 0, -1, &func_800F73BC_28B97C);
    if (D_800C597A != 0) {
...
INCLUDE_ASM(s32, "overlays/ovl_4D_ThowmpTollYoshiBoard/28ABA0", func_800F66D0_28AC90);
...
INCLUDE_ASM(s32, "overlays/ovl_4D_ThowmpTollYoshiBoard/28ABA0", func_800F6A98_28B058);
...
void func_800F73BC_28B97C(omObjData* arg0) {
    if (D_800F5144 != 0) {
        if (D_800F7620 != 0) {
            func_800726AC(6, 8);
        } else {
...
void func_800F7524_28BAE4(void) {
    DestroyObject(D_800F76B8);
    DestroyObject(D_800F76B4);
}
