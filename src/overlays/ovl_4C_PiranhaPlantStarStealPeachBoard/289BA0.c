    ...
    if (gPlayers[D_800F75E0_PiranhaPlantStarStealPeachBoard].starAmount == 0) {
        ...
        for(i = 0; i < 0x15F; i += 5) {
            ...
            temp_s0_2 = D_800F74FC_PiranhaPlantStarStealPeachBoard;
                //temp_s0_2->coords.x = D_800F752C_PiranhaPlantStarStealPeachBoard.x + (_sinf((i * 5) * 0.017453292519943295) * var_f24) ;
            new_var3 = &D_800F752C_PiranhaPlantStarStealPeachBoard.x;
            temp_s0_2->coords.x = (*new_var3) + (_sinf((i * 5) * 0.017453292519943295) * var_f24);
            
            temp_s0_2 = D_800F74FC_PiranhaPlantStarStealPeachBoard;
            temp_s0_2->coords.y = D_800F752C_PiranhaPlantStarStealPeachBoard.y + 200.0f + (i / 2);
            
            temp_s0_2->coords.z = D_800F752C_PiranhaPlantStarStealPeachBoard.z + (_cosf((i * 5) * 0.017453292519943295) * var_f24);
            temp_s0_2 = D_800F74FC_PiranhaPlantStarStealPeachBoard;
            
            temp_s0_2->unk_18.x = _sinf(var_f22 * 0.017453292519943295);
            temp_s0_2 = D_800F74FC_PiranhaPlantStarStealPeachBoard;
            
            temp_s0_2->unk_18.z = _cosf(var_f22 * 0.017453292519943295);
