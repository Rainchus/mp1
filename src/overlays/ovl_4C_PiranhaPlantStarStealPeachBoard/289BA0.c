...
void func_800F65E0_289BA0(void) {
    ...
    func_8006CEA0();
    omAddPrcObj(func_800F66B4_289C74, 0x300, 0, 0);
    omAddObj(0x1000, 0, 0, -1, &func_800F7020_28A5E0);
...
void func_800F66B4_289C74(void) {
    ...
    if (gPlayers[D_800F75E0].starAmount == 0) {
        ...
        D_800F74FC->xScale = 0.5f;
        D_800F74FC->yScale = 0.5f;
        D_800F74FC->zScale = 0.5f;
...
void func_800F7020_28A5E0(omObjData* arg0) {
    if (D_800F5144 != 0) {
