...
INCLUDE_ASM(s32, "overlays/ovl_3E_FirstMap/257020", func_800F714C_257B5C); //has rodata jump table
...
INCLUDE_ASM(s32, "overlays/ovl_3E_FirstMap/257020", func_800F77B4_2581C4);
