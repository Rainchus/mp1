...
INCLUDE_ASM(s32, "overlays/ovl_67_LogosSequenceCopy/2BAA10", func_800F6778_2BAB78);
...
void func_800F6AD4_2BAED4(void) {
    ...
    if (LeoDriveExistBool != 0) {
        ...
        if (D_800F6F70 != 0) {
            ...
            omAddPrcObj(func_800F6778_2BAB78, 0x5000, 0, 0);
            D_800F6F70 = 0x2C;
            var_s0 = 0;
        }
    }
...
INCLUDE_ASM(s32, "overlays/ovl_67_LogosSequenceCopy/2BAA10", func_800F6C1C_2BB01C); //https://decomp.me/scratch/rZb4x
...
INCLUDE_ASM(s32, "overlays/ovl_67_LogosSequenceCopy/2BAA10", func_800F6CEC_2BB0EC);

INCLUDE_ASM(s32, "overlays/ovl_67_LogosSequenceCopy/2BAA10", func_800F6E10_2BB210);
