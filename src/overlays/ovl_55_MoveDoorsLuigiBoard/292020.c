...
void func_800F65E0_292020(void) {
    ...
    func_8006CEA0();
    omAddPrcObj(func_800F7198_292BD8, 0x300, 0, 0);
    omAddObj(0x1000, 0, 0, -1, &func_800F74C8_292F08);
...
INCLUDE_ASM(s32, "overlays/ovl_55_MoveDoorsLuigiBoard/292020", func_800F66D0_292110);

INCLUDE_ASM(s32, "overlays/ovl_55_MoveDoorsLuigiBoard/292020", func_800F6F14_292954);
...
void func_800F74C8_292F08(omObjData* arg0) {
    if (D_800F5144 != 0) {
        if (D_800F7720 != 0) {
            func_800726AC(6, 8);
        } else {
