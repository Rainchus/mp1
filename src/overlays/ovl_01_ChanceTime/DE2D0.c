...
void func_800FF6D0_DE2D0(omObjData* arg0) {
    if (D_80101360 == 0) {
        if ((arg0->trans.x > -180.0f) && (arg0->trans.x < 180.0f) && (D_801011F8 == 1)) {
...
void func_800FF780_DE380(omObjData* arg0) {
...
void func_800FF820_DE420(void) { //fake match
    ...
    if (((D_800F3FB0->trans.y + new_var3->unk_34) - 230.0f) >= (-40.0f)) {
...
void func_800FF8A4_DE4A4(omObjData* arg0) {
    unkGlobalStruct_02* temp_s0;
...
void func_800FF930_DE530(omObjData* arg0) {
