...
void func_800F6D88_298758(omObjData*);
...
void func_800F65E0_297FB0(void) {
    ...
    func_8006CEA0();
    omAddPrcObj(func_800F66BC_29808C, 0x300, 0x2000, 0);
    omAddObj(0x1000, 0, 0, -1, &func_800F6D88_298758);
    func_80060128(0x12);
...
void func_800F6D88_298758(omObjData* arg0) {
    if (D_800F5144 != 0) {
