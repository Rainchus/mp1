...
void func_800F65E0_1FF1E0(void) {
    ...
    omAddObj(10, 13, 38, 0, &func_800F7B40_200740);
    omAddObj(20, 3, 4, 1, &func_800F9724_202324);
    omAddObj(20, 3, 4, 1, &func_800F9724_202324);
    omAddObj(20, 3, 4, 1, &func_800F9724_202324);
    omAddObj(20, 3, 4, 1, &func_800F9724_202324);
    D_800FE478 = omAddObj(20, 6, 4, -1, &func_800FAB8C_20378C);
    D_800FE4AC = omAddObj(40, 2, 0, -1, &func_800FB28C_203E8C);
    D_800FE494 = omAddObj(42, 2, 0, -1, &func_800FB180_203D80);
    D_800FE4C4 = omAddObj(45, 1, 0, -1, &func_800F6F04_1FFB04);
    omAddObj(0, 0, 0, -1, &func_800F6AC0_1FF6C0);
    D_800FE470[1] = omAddObj(6, 4, 0, -1, &func_800F6BE4_1FF7E4);
    D_800FE47C = omAddObj(30, 0, 0, -1, &func_800F7034_1FFC34);
    omAddObj(0x2710, 0, 0, -1, &func_800FBF30_204B30);
    D_800FE4A8 = omAddObj(6, 0, 0, -1, NULL);
...
void func_800F6AC0_1FF6C0(omObjData* arg0) {
    s32 i;
...
void func_800F6B28_1FF728(void) {
    ...
    case 0:
        if (D_800FE490 == NULL) {
            D_800FE490 = omAddObj(4, 0, 0, -1, &func_800FBAA4_2046A4);
            return;
        }
    case 1:
        return;
    case 2:
        if (D_800FE498 == NULL) {
            D_800FE498 = omAddObj(4, 0, 0, -1, &func_800FBB5C_20475C);
        }
        break;
    }
}

void func_800F6BE4_1FF7E4(omObjData* arg0) {
    ...
    func_80038A9C((&D_800F2B7C[arg0->model[0]])->unk_6C, temp_s0, 0, D_800FE3B0);
    ...
    temp_s0_2 = HuMemTempDirectMalloc(sizeof(unkGlobalStruct_02), 0x7918);
    ...
    temp_s0_3 = HuMemTempDirectMalloc(sizeof(unkGlobalStruct_02), 0x7918);
...
void func_800F6DF4_1FF9F4(omObjData* arg0) {
    f32 temp_f2;

    if ((D_800FE464 != 0) && (arg0->work[0] == 1)) {
...
void func_800F6E80_1FFA80(omObjData* arg0) {
    f32 temp_f2;
...
void func_800F6F04_1FFB04(omObjData* arg0) {
...
INCLUDE_ASM(s32, "overlays/ovl_2D_RunningOfTheBulb/1FF1E0", func_800F7278_1FFE78);

INCLUDE_ASM(s32, "overlays/ovl_2D_RunningOfTheBulb/1FF1E0", func_800F7364_1FFF64);

INCLUDE_ASM(s32, "overlays/ovl_2D_RunningOfTheBulb/1FF1E0", func_800F7478_200078);

INCLUDE_ASM(s32, "overlays/ovl_2D_RunningOfTheBulb/1FF1E0", func_800F77B4_2003B4);

INCLUDE_ASM(s32, "overlays/ovl_2D_RunningOfTheBulb/1FF1E0", func_800F7A0C_20060C);
...
INCLUDE_ASM(s32, "overlays/ovl_2D_RunningOfTheBulb/1FF1E0", func_800F7B5C_20075C);

void func_800F8210_200E10(omObjData* arg0) {
    u16 temp_s0;
    s32 temp_s1;
    s16 temp_s3;
    s16 temp_s4;
...
INCLUDE_ASM(s32, "overlays/ovl_2D_RunningOfTheBulb/1FF1E0", func_800F82F4_200EF4);

void func_800F8D80_201980(omObjData* arg0) {
    ...
    if (++temp_s0->unk_54 >= 20) {
        ...
        if (arg0 == D_800FE4A0) {
            func_800258EC(D_800FE4AC->model[0], 4, 4);
        }
        arg0->func_ptr = NULL;
    }
}

void func_800F8EA0_201AA0(omObjData* arg0) {
    omObjData* temp_s1;
    f32 temp_f0;
    s16* temp_a0;
    s16* temp_v0_2;
    ...
    *temp_a0 = 0;
    ...
    if (arg0->trans.z > D_800FE364[temp_a1->unk_58][1]) {
...
INCLUDE_ASM(s32, "overlays/ovl_2D_RunningOfTheBulb/1FF1E0", func_800F9094_201C94); //https://decomp.me/scratch/eJF8g

INCLUDE_ASM(s32, "overlays/ovl_2D_RunningOfTheBulb/1FF1E0", func_800F947C_20207C);

INCLUDE_ASM(s32, "overlays/ovl_2D_RunningOfTheBulb/1FF1E0", func_800F9550_202150);

INCLUDE_ASM(s32, "overlays/ovl_2D_RunningOfTheBulb/1FF1E0", func_800F960C_20220C);

void func_800F9648_202248(void) {
}

INCLUDE_ASM(s32, "overlays/ovl_2D_RunningOfTheBulb/1FF1E0", func_800F9650_202250);

INCLUDE_ASM(s32, "overlays/ovl_2D_RunningOfTheBulb/1FF1E0", func_800F9724_202324);

INCLUDE_ASM(s32, "overlays/ovl_2D_RunningOfTheBulb/1FF1E0", func_800F98F0_2024F0);

INCLUDE_ASM(s32, "overlays/ovl_2D_RunningOfTheBulb/1FF1E0", func_800F9C2C_20282C);

void func_800FA2B8_202EB8(omObjData* arg0) {
...
void func_800FA36C_202F6C(omObjData* arg0) {
...
void func_800FA41C_20301C(omObjData* arg0) {
...
INCLUDE_ASM(s32, "overlays/ovl_2D_RunningOfTheBulb/1FF1E0", func_800FA44C_20304C);
...
INCLUDE_ASM(s32, "overlays/ovl_2D_RunningOfTheBulb/1FF1E0", func_800FA5EC_2031EC);

INCLUDE_ASM(s32, "overlays/ovl_2D_RunningOfTheBulb/1FF1E0", func_800FA78C_20338C);

INCLUDE_ASM(s32, "overlays/ovl_2D_RunningOfTheBulb/1FF1E0", func_800FAA40_203640);

INCLUDE_ASM(s32, "overlays/ovl_2D_RunningOfTheBulb/1FF1E0", func_800FAB8C_20378C);

INCLUDE_ASM(s32, "overlays/ovl_2D_RunningOfTheBulb/1FF1E0", func_800FAD68_203968);

INCLUDE_ASM(s32, "overlays/ovl_2D_RunningOfTheBulb/1FF1E0", func_800FAE18_203A18);

INCLUDE_ASM(s32, "overlays/ovl_2D_RunningOfTheBulb/1FF1E0", func_800FB0D8_203CD8);

INCLUDE_ASM(s32, "overlays/ovl_2D_RunningOfTheBulb/1FF1E0", func_800FB180_203D80);

INCLUDE_ASM(s32, "overlays/ovl_2D_RunningOfTheBulb/1FF1E0", func_800FB28C_203E8C);

INCLUDE_ASM(s32, "overlays/ovl_2D_RunningOfTheBulb/1FF1E0", func_800FB3F8_203FF8);

INCLUDE_ASM(s32, "overlays/ovl_2D_RunningOfTheBulb/1FF1E0", func_800FB540_204140);

void func_800FB738_204338(omObjData* arg0) {
    u16 temp_v0;
...
INCLUDE_ASM(s32, "overlays/ovl_2D_RunningOfTheBulb/1FF1E0", func_800FB8EC_2044EC);

void func_800FBAA4_2046A4(omObjData* arg0) {
    switch (D_800FE4B4) {
    case 0:
        if (func_80072718() == 0) {
            D_800FE4B4 = 1;
...
INCLUDE_ASM(s32, "overlays/ovl_2D_RunningOfTheBulb/1FF1E0", func_800FBB5C_20475C);
...
void func_800FBF74_204B74(omObjData* arg0) {
    f32 temp_f20;
    f32 temp_f22;
    f32 var_f2;
    f32 var_f4;
    ...
    if (arg0 == D_800FE4A0) {
        ...
        if (!(((unkGlobalStruct_00*) D_800FE4A0->unk_50)->unk_E4->unk0 & 4)) {
            var_f4 = D_800FE4A0->trans.x;
            var_f2 = D_800FE4A0->trans.z;
        } else {
            var_f4 = D_800FE478_ovl2D->trans.x;
            var_f2 = D_800FE478_ovl2D->trans.z;
        }
...
INCLUDE_ASM(s32, "overlays/ovl_2D_RunningOfTheBulb/1FF1E0", func_800FC0F4_204CF4);

INCLUDE_ASM(s32, "overlays/ovl_2D_RunningOfTheBulb/1FF1E0", func_800FCEA0_205AA0);

INCLUDE_ASM(s32, "overlays/ovl_2D_RunningOfTheBulb/1FF1E0", func_800FD394_205F94);
...
u16 func_800FDAC4_2066C4(omObjData* arg0, omObjData** arg1, f32* arg2) {
    omObjData* temp_v1;
    f32 temp_f12;
    f32 temp_f2;
    u16 i;
...
omObjData* func_800FDCAC_2068AC(omObjData* arg0, f32* arg1) {
    omObjData* temp_s0;
    omObjData* var_s3;
    f32 temp_f0;
    f32 temp_f0_2;
...
s32 func_800FDDC0_2069C0(omObjData* arg0) {
    unkGlobalStruct_00* temp_s0;
    ...
    if (arg0 == D_800FE4A0) {
        if (!(arg0->trans.z > -1850.0f)) {
            ...
            for (i = 0; i < 4; i++) {
                func_800258EC(D_800FE460[i]->model[9], 4, 4);
            }
            ...
            for (i = 0; i < 4; i++) {
                ...
                if (temp_s1->unk_00 & 8) {
                    ...
                    if (temp_s1->unk_02 < 5) {
                        ...
                        func_800211BC(D_800FE49C[i]->model[2], temp_s1->unk_04);
                    }
                }
