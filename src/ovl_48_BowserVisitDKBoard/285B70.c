...
Vec3f D_800F70CC_28665C = {30.0f, 350.0f, 1475.0f};
Vec3f D_800F70D8_286668 = {30.0f, 65.0f, 1475.0f};
...
//bss
u8 D_800F7170_ovl48 = NULL;
unk_Struct03* D_800F7174_ovl48 = NULL;
unk_Struct03* D_800F7178_ovl48 = NULL;
unk_Struct03* D_800F717C_ovl48 = NULL;
Object* D_800F7180_ovl48 = NULL;
...
void func_800F66BC_285C4C(void) {
    ...
    if (gPlayers[D_800F7170_ovl48].coinAmount == 0) {
        ...
        func_8004F40C(D_800F7174_ovl48, 0, 2);
        SleepProcess(0x14);
        var_f20 = D_800F70CC_28665C.y;

        while (D_800F70D8_286668.y <= var_f20) {
            D_800F7178_ovl48->unk_30 = var_f20;
            SleepVProcess();
            var_f20 -= 2.0f;
        }

        D_800F7178_ovl48->unk_30 = D_800F70D8_286668.y;
...
void func_800F6C14_2861A4(Object* arg0) {
    ...
    temp_s0->unk_18.x = func_80088060(arg0->unk_24 * (PI / 180.0));
    temp_s0_2 = D_800F7178_ovl48;
    temp_s0_2->unk_18.z = func_800855C0(arg0->unk_24 * (PI / 180.0));
    if ((arg0->unk_4C == 0) || !(arg0->unk_24 < -310.0f)) {
        ...
        temp_s0_3->unk_30 = ((func_80088060(arg0->unk_28 * (PI / 180.0))) * 4.0f) + D_800F70D8_286668.y;
...
void func_800F6E1C_2863AC(void) {
    func_8003DAA8();
    func_8004F2AC();
    D_800F7174_ovl48 = func_8003DBE0(6, D_800F70F0_286680);
    ...
    D_800F7174_ovl48->unk_2C = 1.5f;
    D_800F7174_ovl48->unk_28 = 1.5f;
    D_800F7174_ovl48->unk_24 = 1.5f;
    D_800F7178_ovl48 = func_8003DBE0(0x28, NULL);
    D_800F7178_ovl48->coords.x = D_800F70CC_28665C.x;
    D_800F7178_ovl48->coords.y = 0.0f;
    D_800F7178_ovl48->unk_30 = D_800F70CC_28665C.y;
    D_800F7178_ovl48->coords.z = D_800F70CC_28665C.z;
    ...
    D_800F717C_ovl48 = func_8003DBE0(func_80052F04(D_800F7170_ovl48), D_800F7148_2866D8[gPlayers[D_800F7170_ovl48].characterID]);
