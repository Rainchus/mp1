...
INCLUDE_ASM(const s32, "ovl_18_PlatformPeril/16C6A0", func_800F6F68_16C6A8);
...
INCLUDE_ASM(const s32, "ovl_18_PlatformPeril/16C6A0", func_800F8AE8_16E228);

INCLUDE_ASM(const s32, "ovl_18_PlatformPeril/16C6A0", func_800F8B7C_16E2BC);

INCLUDE_ASM(const s32, "ovl_18_PlatformPeril/16C6A0", func_800F8C2C_16E36C);

INCLUDE_ASM(const s32, "ovl_18_PlatformPeril/16C6A0", func_800F90C0_16E800);

INCLUDE_ASM(const s32, "ovl_18_PlatformPeril/16C6A0", func_800F922C_16E96C);
