...
extern u32 D_800F383C_F38CC; // Unk
extern OSMesgQueue D_800ED3C8_ED458; // Another system's message queue

/* Initialize Graphics SwapChain */
void func_8001A600_1B200(void **arg1, s32 arg2, s32 arg3, u64 **arg4, s32 *arg5) {
    func_8001AB84_1B784(arg1, arg2, arg3);
    func_8001ABAC_1B7AC(arg4);
    func_8001ABE8_1B7E8(arg5);
    func_8001ABF4_1B7F4(0);
    ...
    osCreateThread(&swapChainThread, 0x10, &func_8001A7DC_1B3DC, NULL, &swapChainStack, 0x64);
    osStartThread(&swapChainThread);
}

/* Retrieve available frame buffer (triple buffering?) */
void *func_8001A750_1B350(void) {
    void *current;
    void *next;
    void *fBuffer;
    s16 i;
...
/* Swap Chain Loop */
void func_8001A7DC_1B3DC(void* arg0) {
    unkSchedStruct sp10;
    OSMesgQueue mesgQueue;
    ...
    func_800639F8_645F8(&sp10, &mesgQueue, 1);

    while (TRUE) {
        do {
            recvmesg:
            osRecvMesg(&mesgQueue, NULL, 1);
            if ((D_800F383C_F38CC - var_s4) < D_800D5FF0_D6080) {
                goto recvmesg;
            }
    
            var_s4 = D_800F383C_F38CC;
            func_800613E8_61FE8();
            pAvailableFrameBuffer = func_8001A750_1B350();
        ...
        do { do {
            ...
            osSendMesg(&D_800ED3C8_ED458, (OSMesg) pSwapChain, 1);
        ...
        for (i = 1; i < D_800D5FF0_D6080; i++) {
            osRecvMesg(&mesgQueue, NULL, 1);
        }
    
        osViSwapBuffer(pAvailableFrameBuffer);
        if (D_800ED0C4_ED154 == 0) {
            osViBlack(0);
        }
        D_800ED0C4_ED154++;
        func_80061414_62014(); // empty function
    }
}

/* Retrieve graphics OSMesg from ring buffer */
graphicsMessage* func_8001AA70_1B670(void) {
...
u8 func_8001AAC4_1B6C4(s32 arg0, u16 arg1, s32 arg2, OSMesgQueue *arg3, s32 arg4) {
...
void func_8001AB84_1B784(void **pool, u16 size, u16 segment) {
...
void func_8001ABA0_1B7A0(u16 size) {
    frameBufferCount = size;
}

/* Initialize gThreadStacks */
void func_8001ABAC_1B7AC(u64 **threadStacks) {
...
void func_8001ABE8_1B7E8(s32 *uCodeAdresses) {
    gUCodeAddresses = uCodeAdresses;
}

/* Swap chain state set? */
void func_8001ABF4_1B7F4(u32 arg0) {
    D_800D5FF0_D6080 = arg0;
}
