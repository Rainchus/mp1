...
void func_800F74C8_292F08(Object* arg0) {
    if (D_800F5144 != 0) {
        if (D_800F7720 != 0) {
            func_800726AC(6, 8);
        } else {
...
void func_800F7528_292F68(void) {
    func_8003DAA8();
    D_800F7824 = func_8003DBE0(0x11, D_800F773C);
    ...
    D_800F7828 = func_8003DBE0(func_80052F04(D_800F7820), D_800C5490[gPlayers[D_800F7820].characterID]);
...
void func_800F7630_293070(void) {
    func_8003E694(D_800F7828);
    func_8003E694(D_800F7824);
}
