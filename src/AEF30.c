...
void func_800AE330(u16* arg0, Vec4f* arg1, Vec4f* arg2) {
    f32 sp0 = arg1->x;
    f32 sp4 = arg1->y;
    f32 sp8 = arg1->z;
    f32 spC = arg1->w;
    f32 sp10 = 1.0f / ((((arg0[3] << 0x10) | arg0[19]) * USHRT_MINV * sp0) 
