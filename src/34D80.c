...
INCLUDE_ASM(s32, "34D80", func_80034180);
...
INCLUDE_ASM(s32, "34D80", func_800342BC);
...
s16 func_800342E0(unk2C0C0StructC0* arg0, u8* arg1, s16 arg2) {
    ...
    temp_s0 = var_a1[1] + 4;
    temp_v0 = HuMemTempDirectMalloc(temp_s0, D_800F0A28);
...
INCLUDE_ASM(s32, "34D80", func_800343C8);

INCLUDE_ASM(s32, "34D80", func_80034420);
...
s32 func_800344BC(unk34D80Struct80* arg0, unk2C0C0StructC0* arg1) {
    ...
    arg0->unk_04 = HuMemTempDirectMalloc(var_s0 * sizeof(unk34D80Struct60*), D_800F0A28);
    arg0->unk_08 = HuMemTempDirectMalloc(var_s0 * sizeof(u8), D_800F0A28);
    sp44 = arg0->unk_0C = HuMemTempDirectMalloc(4096 * sizeof(s16), D_800F0A28);
    sp3C = arg0->unk_10 = HuMemTempDirectMalloc(4096 * sizeof(s32), D_800F0A28);
    ...
    for (var_s6 = var_s5 = sp1E = 0; sp1E < sp2E; sp1E++) {
        ...
        if (temp_s3 != 0) {
            ...
            var_s2 += 13;
            sp14 = HuMemTempDirectMalloc(temp_s3 * sizeof(unk34D80Struct60), D_800F0A28);
            ...
            for (i = 0; i < temp_s3; i++) {
                ...
                switch (temp_a0) {
                    ...
                    case 8:
                        if (var_s6 == 0) {
                            arg1->unk_B8 = HuMemTempDirectMalloc(sizeof(unk2C0C0StructB8), arg1->unk_68 + 1);
                        }
    ...
    arg0->unk_0C = HuMemTempDirectMalloc(D_800D6020 * sizeof(s16), D_800F0A28);
    func_80023A38(sp44, arg0->unk_0C, D_800D6020 * sizeof(s16));
    func_80023728(sp44);

    arg0->unk_10 = HuMemTempDirectMalloc(D_800D6022 * sizeof(s32), D_800F0A28);
...
INCLUDE_ASM(s32, "34D80", func_80034974);
...
s32 func_80034C28(unk2C0C0StructC0* arg0, s16 arg1, u8* arg2) {
    ...
    temp_s3->unk_08 = HuMemTempDirectMalloc(temp_s0 * sizeof(u16), arg0->unk_68 + 1);
    temp_s3->unk_0C = HuMemTempDirectMalloc(temp_s0 * sizeof(s32), arg0->unk_68 + 1);
...
s32 func_80034E04(unk34D80Struct80* arg0, unk34D80Struct40* arg1) {
    ...
    arg0->unk_04 = HuMemTempDirectMalloc(temp_s3 * sizeof(unk34D80Struct60*), D_800F0A28);
...
INCLUDE_ASM(s32, "34D80", func_80034ED8);

INCLUDE_ASM(s32, "34D80", func_800354D4);

INCLUDE_ASM(s32, "34D80", func_80035630);

INCLUDE_ASM(s32, "34D80", func_80035824);

INCLUDE_ASM(s32, "34D80", func_8003589C);

INCLUDE_ASM(s32, "34D80", func_800363C8);

INCLUDE_ASM(s32, "34D80", func_800368AC);

INCLUDE_ASM(s32, "34D80", func_80036930);

INCLUDE_ASM(s32, "34D80", func_800369A0);

INCLUDE_ASM(s32, "34D80", func_800369FC);

INCLUDE_ASM(s32, "34D80", func_80036ABC);

INCLUDE_ASM(s32, "34D80", func_80036AC4);

INCLUDE_ASM(s32, "34D80", func_80036AE4);

INCLUDE_ASM(s32, "34D80", func_80036B00);

INCLUDE_ASM(s32, "34D80", func_80036CC8);

INCLUDE_ASM(s32, "34D80", func_800370D4);

INCLUDE_ASM(s32, "34D80", func_80037178);

INCLUDE_ASM(s32, "34D80", func_80037288);

INCLUDE_ASM(s32, "34D80", func_800373C0);

INCLUDE_ASM(s32, "34D80", func_8003796C);

INCLUDE_ASM(s32, "34D80", func_80037C40);

INCLUDE_ASM(s32, "34D80", func_80037C90);
