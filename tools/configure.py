...
header = (
    ...
    'CPPFLAGS = -I ~/usr/lib/gcc/x86_64-linux-gnu -I. -I include -I include/PR -I include/engine -I include/gcc -I build/include -I src -I src/engine -DF3DEX_GBI_2 -DNDEBUG\n'
